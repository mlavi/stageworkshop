...
MSSQL_SourceVM_Image1="MSSQL_monitoring_1_Oct19_2020"
MSSQL_SourceVM_Image2="MSSQL_monitoring_2_Oct19_2020"
...
case "${OCTET[0]}.${OCTET[1]}" in
  ...
  10.55 ) # HPOC us-east = DUR
    ...
    FILES_METAURL='http://10.55.251.38/workshop_staging/afs-3.7.1.json'
  ...
  10.42 ) # HPOC us-west = PHX
    ...
    FILES_METAURL='http://10.42.194.11/workshop_staging/afs-3.7.1.json'
  ...
  10.136 ) # HPOC us-west = BLR
    ...
    FILES_METAURL='http://10.136.239.13/workshop_staging/afs-3.7.1.json'
